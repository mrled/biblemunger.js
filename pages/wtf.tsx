    ...
    <>
      ...
      <main className="p-8">
        ...
        >
          ...
          <p className="my-2">
            biblemunger is a stupid thing that will replace arbitrary text in
            the Bible with other arbitrary text
          </p>
          <p className="my-2">
            It was inspired by{" "}
          ...
          <p className="my-2">
            ...
            (from{" "}
            <span className="font-bold">menservants and maidservants</span>
            ).
          </p>
          <p className="my-2">
            However, it does search/replace numbers and punctuation, not just
            letters, so if the above behavior is undesirable, surround your
            search and your replacement with spaces. For example,{" "}
            <InternalLink href="/munge/servant/uber driver">
              "servant" ⇒ "uber driver"
            </InternalLink>{" "}
            will only find instances of "servant" when it's surrounded by
            spaces. (This also means that it will not find results of "servant"
            when followed by punctuation.)
          </p>
          <p className="my-2">
            One final thing to note: because it's so strict, it currently is
            case sensitive, such that{" "}
            ...
            . This means that, currently, an uncapitalized search term will
            never match a word that begins a sentence.
          </p>
        </div>
      </main>
    </>
